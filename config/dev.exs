...
host = cors_proxy_host = "10.30.176.65"

dev_janus_host = "10.30.176.65"
...
#
#     openssl req -new -newkey rsa:4096 -days 365 -nodes -x509 -subj "/C=US/ST=Denial/L=Springfield/O=Dis/CN=10.30.176.65" -keyout priv/server.key -out priv/server.pem
